    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        ...
        case 7:
          ...
          (0, _alerts.showAlert)('error', 'Loggout fail, please try again!');
        case 10:
        case "end":
...
var displayMap = exports.displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoiamFuaXNnZWUiLCJhIjoiY2xuYWYycnZ1MDNzeDJwdGp4NW1mZmgxdCJ9.cTjbFsr4bMq1u9BeBlryfw';
  ...
  locations.forEach(function (loc) {
    ...
    var marker = new mapboxgl.Marker({
      element: el
    }).setLngLat(loc.coordinates).addTo(map).setPopup(popup);
...
function asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { Promise.resolve(value).then(_next, _throw); } }
function _asyncToGenerator(fn) { return function () { var self = this, args = arguments; return new Promise(function (resolve, reject) { var gen = fn.apply(self, args); function _next(value) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "next", value); } function _throw(err) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "throw", err); } _next(undefined); }); }; }
var stripe = Stripe('pk_test_51NzXDaIWnz9hd34ezEVptNdGLcq822efqkQ6c2edSUGEgIHEoo1WOSR4hamebxPArHGsBeA1rTrdDm5dpqdnsp4000gEMg5xyb');
...
var changeUserImage = document.getElementById('photo');
...
if (userDataForm) {
  changeUserImage.onchange = function () {
    var _changeUserImage$file = _slicedToArray(changeUserImage.files, 1),
      file = _changeUserImage$file[0];
    if (file) {
...
//# sourceMappingURL=--out-dir/bundle.js.map